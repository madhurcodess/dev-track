...
export const PlayerWorkspace: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initPlayer = () => {
        ...
        events: {
          onReady: (event: any) => {
            ...
            try {
              ...
              if (iframe) {
                // Modern browsers use 'allow' attribute containing 'fullscreen' to prevent precedence warnings
      ...
      try {
        const iframe = document.querySelector('#youtube-player-element') as HTMLIFrameElement | null;
        if (iframe) {
          iframe.setAttribute('allow', 'accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen');
      ...
      <div className="p-4 sm:p-6 lg:p-8 pb-2 max-w-6xl w-full mx-auto">
        ...
        <div className="mt-5 p-5 rounded-3xl bg-white border-2 border-[#121417] shadow-solid">
          <div className="flex flex-col gap-4">
            {/* Title & Metadata (Full Width - prevents column squeeze) */}
            <div className="w-full min-w-0">
              ...
              <h1 className="text-base sm:text-lg font-extrabold text-[#121417] tracking-tight leading-snug break-words">
                {activeVideo.title}
              </h1>
            ...
            <div className="pt-3.5 border-t border-[#121417]/10 flex flex-wrap items-center justify-between gap-3">
              {/* Left group: Prev/Next & Playback Rate */}
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="relative">
                  ...
                  {isRateMenuOpen && (
                    <div className="absolute bottom-full mb-2 left-0 bg-white border-2 border-[#121417] rounded-2xl shadow-solid p-1.5 z-50 flex flex-col gap-1 min-w-[80px]">
              ...
              {/* Right group: Timestamp note, Completion toggle & View options */}
              <div className="flex items-center gap-2 flex-wrap">
                {/* Timestamp Note Quick Button */}
                <button
                  onClick={handleQuickTimestampNote}
                  className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#D4E4FC] hover:bg-[#C2DBFB] text-[#121417] text-xs font-bold border-2 border-[#121417] shadow-sm transition-all hover:scale-105 active:scale-95"
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold border-2 border-[#121417] transition-all hover:scale-105 ${
                    activeVideo.completed
                ...
                <button
                  ...
                  className="p-1.5 rounded-full bg-white hover:bg-slate-50 border border-[#121417]/30 text-[#121417] transition-colors"
